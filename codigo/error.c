...
void error_print(int ne)
{
	switch(ne)
	{
		...
		case 36: printf("\t Error %d: Símbolo inesperado al comienzo de lista decl. parámetros\n", ne); break; 	 
		case 37: printf("\t Error %d: Símbolo incorrecto dentro de lista decl. parámetros\n", ne); break; 
